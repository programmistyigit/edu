...
router.post("/add", async (req, res) => {
    ...
    const teacherIDlist = businesmen.followTeacherId.map(e => e._id)
    ...
    await BusinesMenSChema.findByIdAndUpdate(req.id, { $push: { teachersID: teacher._id }, $pull: { followTeacherId: teacher._id } })
...
router.delete("/delete", async (req, res) => {
    ...
    const teacherIDlist = businesmen.teachersID.map(e => e._id)
    ...
    await BusinesMenSChema.findByIdAndUpdate(req.id, { $pull: { teachersID: teacher._id } })
