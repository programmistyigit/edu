...
const FirstComponent = ({ navigation }) => {
    const { recoverDate , setShowDateTimePicker , date , formData , errorMessage} = useContext(MotherContext)
    const handleClick = () =>{
        const schema = yup.object().shape({
            birthDay:yup.string().required("Tug'ilgan  kuningizni belgilang !"),
            firstName:yup.string().required("Familyangizni kiriting !"),
